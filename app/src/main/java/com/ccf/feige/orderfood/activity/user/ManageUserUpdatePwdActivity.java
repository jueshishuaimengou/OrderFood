...
public class ManageUserUpdatePwdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText pwd = findViewById(R.id.user_manage_updateBusiness_pwd_pwd);
        EditText  confirm = findViewById(R.id.user_manage_updateBusiness_pwd_confirmPwd);

        String account= Tools.getOnAccount(this);
        Button button = findViewById(R.id.user_manage_updateBusiness_pwd_update);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pwdT.isEmpty()){
                    ...
                    int a= AdminDao.updateCommentUserPwd(account,pwdT);
                    if(a==1){
